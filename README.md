# README
 ...
 [![React Async](https://raw.githubusercontent.com/async-library/react-async/HEAD/react-async.png)](https://react-async.dev)  
 Handle promises with ease.  
  
 [![](https://codefund.io/properties/458/sponsor)](https://codefund.io/properties/458/visit-sponsor)  


 [![latest version](https://badgen.net/npm/v/react-async?icon=npm&label=react-async)](https://www.npmjs.com/package/react-async) [![montly downloads](https://badgen.net/npm/dm/react-async)](https://www.npmjs.com/package/react-async) [![minified size](https://badgen.net/bundlephobia/min/react-async)](https://bundlephobia.com/result?p=react-async) [![license](https://badgen.net/npm/license/react-async)](https://opensource.org/licenses/ISC)  
 [![issues](https://badgen.net/github/open-issues/async-library/react-async?icon=github)](https://github.com/async-library/react-async/issues) [![pull requests](https://badgen.net/github/open-prs/async-library/react-async?icon=github)](https://github.com/async-library/react-async/pulls) [![releases](https://badgen.net/github/releases/async-library/react-async?icon=github)](https://github.com/async-library/react-async/releases) [![contributors](https://badgen.net/github/contributors/async-library/react-async?icon=github)](https://github.com/async-library/react-async/graphs/contributors) [![live examples](https://badgen.net/badge/live%20examples/available/pink?icon=now)](https://react-async.now.sh/examples/)  
 [![circleci status](https://badgen.net/circleci/github/async-library/react-async/master?icon=circleci)](https://circleci.com/gh/async-library/react-async) [![travis status](https://badgen.net/travis/async-library/react-async?icon=travis)](https://travis-ci.com/async-library/react-async) [![code coverage](https://badgen.net/codecov/c/github/async-library/react-async/master?icon=codecov)](https://codecov.io/gh/async-library/react-async) [![code quality](https://www.codefactor.io/repository/github/async-library/react-async/badge)](https://www.codefactor.io/repository/github/async-library/react-async) [![DeepScan grade](https://deepscan.io/api/teams/5549/projects/7406/branches/74183/badge/grade.svg)](https://deepscan.io/dashboard#view=project&tid=5549&pid=7406&bid=74183)  
 ![dependencies](https://badgen.net/david/dep/async-library/react-async/packages/react-async) ![devDependencies](https://badgen.net/david/dev/async-library/react-async) ![peerDependencies](https://badgen.net/david/peer/async-library/react-async/packages/react-async)
...
* Supports [abortable fetch](https://developers.google.com/web/updates/2017/09/abortable-fetch) by providing an AbortController
...
> ### Upgrading to v8
>
> Version 8 comes with breaking changes. See [Upgrading](./#upgrading) for details. A [codemod](https://github.com/async-library/react-async/tree/master/codemods) is available.
...
> Using [helper components](./#with-helper-components) can greatly improve readability of your render functions by not having to write all those conditional returns.
...
Several [helper components](./#helper-components) are available to improve legibility. They can be used with `useAsync` by passing in the state, or with `<Async>` by using Context. Each of these components simply enables or disables rendering of its children based on the current state.
...
Here's several examples to give you an idea of what's possible with React Async. For fully working examples, please check out the [`examples` directory](https://github.com/async-library/react-async/tree/master/examples).
